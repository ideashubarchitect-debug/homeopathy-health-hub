...
const label = "block font-mono-ui text-[10px] uppercase tracking-[0.15em] text-muted-foreground mb-2";
const field =
      ...
      <div className="min-h-screen bg-background">
        ...
        <main className="pt-32 pb-24">
          <div className="container mx-auto px-6 lg:px-16 max-w-3xl">
            ...
            <div className="border border-border bg-background overflow-hidden" style={{ height: 720 }}>
              <iframe
            ...
            <div className="mt-8 flex flex-col sm:flex-row gap-3">
              <a href={CALENDLY_URL} target="_blank" rel="noopener noreferrer"
                className="px-8 py-4 bg-foreground text-primary-foreground text-sm font-body font-medium tracking-wide hover:bg-primary transition-all text-center">
                Open Calendly in a new tab
              </a>
              <button onClick={() => navigate("/")}
                className="px-8 py-4 border border-border text-foreground text-sm font-body font-medium tracking-wide hover:border-foreground/60 transition-all">
                Back to home
              </button>
            </div>
          </div>
    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="pt-32 pb-24">
        <div className="container mx-auto px-6 lg:px-16 max-w-4xl">
          <p className="font-mono-ui text-xs uppercase tracking-[0.2em] text-muted-foreground mb-4">
            Step 1 of 2 — Patient Intake & Consent Form
          </p>
          <h1 className="font-display text-4xl lg:text-5xl tracking-[-0.02em] text-foreground mb-6">
          ...
          <p className="font-body text-lg text-muted-foreground mb-12 max-w-2xl">
            ...
            straight to booking your consultation.
          </p>
          ...
          <form onSubmit={handleSubmit} className="space-y-10">
            ...
            <section className="space-y-5">
              <h2 className="font-display text-2xl text-foreground border-b border-border pb-3">
                3. Past Complaints & Medical History
              </h2>
